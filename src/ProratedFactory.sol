...
contract ProratedFactory is Owned {
    ...
    /// @notice SSTORE2 pointers for ProratedPool bytecode (split to avoid 24KB limit)
    ...
    constructor(
        ...
        bytes memory fullBytecode = type(ProratedPool).creationCode;
    ...
    function createPool(
        ...
        // Step 2: Read both bytecode chunks from SSTORE2
