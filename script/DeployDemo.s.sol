...
contract DeployDemo is Script {
    ...
    function run() external {
        ...
        // Step 8: Log all deployed addresses
    ...
    function createDemoPool(
        ...
        DemoProratedPool.PoolConfig memory config = DemoProratedPool.PoolConfig({
            owner: msg.sender,
            tokenName: tokenName,
        ...
        return DemoProratedFactory(demoProratedFactory).createPool(config, salt);
    }
